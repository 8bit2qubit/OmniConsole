...
- **OmniCharm 小工具** – 遊戲中快速存取的 Game Bar 小工具：一鍵開啟**工作檢視**、**XBOX 媒體櫃**、**檔案總管**或 **Steam 內嵌介面**；切換**貓又模式**、控制器預設版面、游標速度與 **Steam 遊戲內嵌介面** (長按 ☰)。檔案總管直接開啟**本機**，而貓又模式的內建映射涵蓋它，瀏覽與開啟檔案全程用手把就行。
