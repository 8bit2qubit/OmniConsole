...
- **OmniCharm widget** – A Game Bar widget for in-game quick access. Open **Task View**, the **XBOX Library**, **File Explorer**, or the **Steam Overlay** in one tap; toggle **Nekomata Mode**, controller layout preset, cursor speed, and the **Steam In-Game Overlay** (long-press ☰). File Explorer opens straight to **This PC**, and Nekomata Mode's built-in mapping already covers it, so you browse and open your files with the gamepad alone.
